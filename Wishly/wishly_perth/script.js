document.addEventListener("DOMContentLoaded", () => {
    ...
    if (giftBox) {
        giftBox.addEventListener("click", () => {
            if (!isOpened) {
                giftBox.src = "img/cocoagift-open.png"; // Change to open gift image
                giftText.textContent = "surprise :)";
                giftText.style.color = "#a98177";
                isOpened = true;
            } else {
