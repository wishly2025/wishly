document.addEventListener("DOMContentLoaded", () => {
    ...
    pb3.addEventListener("click", () =>{
      window.location.href = "http://wishly.club/wishly_nuan/forthpage.html";
    });}else{
    ...
    pb4.addEventListener("click", () =>{
        window.location.href = "http://wishly.club/wishly_nuan/fifthpage.html";
      });
    }

    if (startButton) {
        startButton.addEventListener("click", () => {
            window.location.href = "http://wishly.club/wishly_nuan/eightpage.html"; // Redirects to page 8
        });
    } else {
        console.error("❌ The 'start-button' was not found!");
    }
    ...
    if (giftBox) {
        giftBox.addEventListener("click", () => {
            if (!isOpened) {
                ...
                window.location.href = "http://wishly.club/wishly_nuan/sixthpage.html"; // Redirect on second click
            }
        });
    }
    ...
    if (revealButton) {
        revealButton.addEventListener("click", () => {
            window.location.href = "http://wishly.club/wishly_nuan/thirdpage.html"; // Redirect to next page
        });
    }
...
function dropPhotoStrip() {
    if (!isdrop) {
        ...
        window.location.href = "http://wishly.club/wishly_nuan/tenpage.html";
    }
}
