document.addEventListener("DOMContentLoaded", () => {
    ...
    if (giftBox) {
        giftBox.addEventListener("click", () => {
            if (!isOpened) {
                giftBox.src = "img/mdi_gift-open (1).png"; // Change to open gift image
                giftText.textContent = "surprise :)";
                giftText.style.color = "#213555";
                isOpened = true;
            } else {
